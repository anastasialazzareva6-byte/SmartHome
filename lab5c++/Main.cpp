...
public:
    ...
    static void initializeDefaultData(vector<shared_ptr<Room>>& rooms,
        ...
        try {
            ...
            devices.push_back(make_shared<Device>("DEV001", "Умный телевизор", "Samsung",
                DeviceType::MULTIMEDIA, rooms[0], 120.0));
            devices.push_back(make_shared<Device>("DEV002", "Кондиционер", "LG",
                DeviceType::CLIMATE_CONTROL, rooms[0], 1500.0));
            devices.push_back(make_shared<Device>("DEV003", "Умный свет", "Philips",
                DeviceType::ACTUATOR, rooms[1], 15.0));
            devices.push_back(make_shared<Device>("DEV004", "Камера безопасности", "Xiaomi",
                DeviceType::SECURITY, rooms[2], 8.0));
            devices.push_back(make_shared<Device>("DEV005", "Датчик температуры", "Bosch",
            ...
            users.push_back(make_shared<User>("USR001", "admin", "123", AccessLevel::ADMIN, "", ""));
            ...
            morningScenario->addAction(make_unique<ScenarioAction>("ACT002", devices[0], "turnOn"));
...
public:
    ...
    void addDevice() {
        ...
        if (roomChoice > 0 && roomChoice <= rooms.size()) {
            ...
            auto newDevice = make_shared<Device>(
