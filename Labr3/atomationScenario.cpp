...
void AutomationScenario::addAction(ScenarioAction* action) {
...
AutomationScenario* AutomationScenario::deserialize(const std::string& data) {
    ...
    AutomationScenario* scenario = new AutomationScenario(id, name, time);
